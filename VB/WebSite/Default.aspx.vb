...
Partial Public Class [Default]
    ...
    Protected Sub Date_Validation(ByVal sender As Object, ByVal e As ValidationEventArgs)
        Dim date1 As Date = CDate(e.Value)
        Dim de As ASPxDateEdit = TryCast(sender, ASPxDateEdit)
        ...
        If de.ID.Contains("HireDate") Then
            Dim birthDate As Date = CheckDateEdit("BirthDate", visibleIndex)
            ...
            End If
        Else
            Dim hireDate As Date = CheckDateEdit("HireDate", visibleIndex)
    ...
    Private Function CheckDateEdit(ByVal dateEditName As String, ByVal visibleIndex As Integer) As Date
        ...
        If de2 IsNot Nothing Then
            Dim date2 As Date = CDate(de2.Value)
            Return date2
        End If
        Return Date.MinValue
    End Function
    Private Sub CheckYears(ByVal e As ValidationEventArgs, ByVal hireDate As Date, ByVal birthDate As Date)
